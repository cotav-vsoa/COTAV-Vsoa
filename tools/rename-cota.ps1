...
foreach ($f in $htmlFiles) {
  ...
  $t = $t.Replace('FUERZAS ARMADAS ARGENTINAS VSOA - VATSIM SPECIAL OPERATION ASOCIATED', 'COMANDO DE OPERACIONES AÉREAS TÁCTICAS ARGENTINAS VSOA - VATSIM SPECIAL OPERATION ASOCIATED')
  $t = $t.Replace('FAAV - VSOA', 'COTA - VSOA')
  $t = $t.Replace('Fuerzas Armadas Argentinas VSOA', 'Comando de Operaciones Aéreas Tácticas Argentinas')
